    ...
    template:`
        <div  v-if="deleted==false">
            <div class="input-group mar-btm">
                <input v-model="itemContent" v-on:change="changeItem" type="text" class="form-control" placeholder="Escribe la opción..." :style="{'pointer-events': enabled, 'background-color': '#'+ color}">
